...
function updateSolc(version) {
    ...
    try {
        ...
        const pkg = require(path_1.default.resolve("node_modules/solc/package.json"));
        currentVersion = pkg.version;
    }
    catch {
        // solc not installed or unreadable
    }
    if (!currentVersion || !semver_1.default.satisfies(currentVersion, version)) {
        try {
            ...
            throw new errors_1.ResolcPluginError(`Compilation failed during solc@${version} installation: ${error.message}`);
        }
    }
}
