...
export interface TestCSALatinHackHelperInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balanceOf"
      | "burn"
...
export interface TestCSALatinHackHelper extends BaseContract {
  connect(runner?: ContractRunner | null): TestCSALatinHackHelper;
  waitForDeployment(): Promise<this>;

  interface: TestCSALatinHackHelperInterface;
